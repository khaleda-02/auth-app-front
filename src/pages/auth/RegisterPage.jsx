    ...
    <div className='w-full h-[100vh]'>
      ...
      <div className='w-full min-h-[92vh] bg-black flex items-center justify-center '>
        ...
        <div className='w-full md:w-[80%] lg:w-[60%] mx-auto bg-white h-full md:h-fit overflow-scroll md:rounded-3xl py-9 px-9'>
          {/* heading */}
          <h2 className='text-center capitalize font-extrabold text-6xl my-4 text-black'>Register Page</h2>
          <p className='text-center capitalize my-4 text-2xl text-gray-black'>hey , Welcome to our Auth application .</p>
